...
- 2026-05-07: Substituição da logo da Fulltime pela logo da KrM (LogoKrM_Final_Extreme.png) no rodapé global da aplicação em `App.tsx`. Arquivo de imagem movido para a pasta `public/`.

        ...
        {produtosFiltrados.map(p => (
          <GlassCard key={p.id} className="p-0 flex flex-col h-full overflow-hidden border-white/5 hover:border-blue-500/30 transition-all">
            ...
            <div className="p-3 md:p-8 flex flex-col flex-1 gap-1 md:gap-2">
              <h3 className="text-[11px] md:text-[13px] font-bold text-white truncate">{p.nome}</h3>
              <p className="text-[9px] md:text-[11px] text-white/60 text-center w-full line-clamp-2 mt-1 leading-tight">{p.descricao}</p>

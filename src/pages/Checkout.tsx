                ...
                <form onSubmit={processPayment} className="flex flex-col gap-4">
                  {paymentMethod === 'credit_card' ? (
                    ...
                    <div className="p-6 bg-green-500/10 rounded-2xl border border-green-500/20 text-center flex flex-col gap-3">
                      ...
                      <p className="text-sm font-medium">O QR Code será gerado na próxima tela.</p>
                      <p className="text-xs text-white/40 leading-relaxed">Liberação instantânea do pedido após o pagamento.</p>
                    </div>
                  )}

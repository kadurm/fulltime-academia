...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {/* Hero */}
      <div id="hero" data-section="hero" className="pt-[160px] md:pt-32 bg-transparent scroll-mt-24 md:scroll-mt-32">
          ...
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="min-h-[22rem]">
                <GlassCard hoverEffect="float" className="p-0 relative h-full w-full overflow-hidden flex flex-col">
                  <div className="w-full aspect-[4/3] md:aspect-video overflow-hidden">
                    <img src="/[FullTime][Ibi][02].jpeg" alt="Unidade Ibituruna" className="w-full h-full object-cover transition-transform duration-500 hover:scale-110 rounded-t-2xl" />
                  </div>
              ...
              <div className="min-h-[22rem]">
                <GlassCard hoverEffect="float" className="p-0 relative h-full w-full overflow-hidden flex flex-col">
                  <div className="w-full aspect-[4/3] md:aspect-video overflow-hidden">
                    <img src="/[FullTime][Planalto][01].jpeg" alt="Unidade Planalto" className="w-full h-full object-cover transition-transform duration-500 hover:scale-110 rounded-t-2xl" />
                  </div>
                  <div className="p-8 flex flex-col gap-4 flex-1">
